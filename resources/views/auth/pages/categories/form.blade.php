		...
		<div class="col-md-12">
			<form role="form" id="submit_form" action="?" method="post" enctype="multipart/form-data">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        @include('auth.common.controls.input', ['label' => 'Tên loại sản phẩm', 'control_name' => 'name', 'control_id' => 'name'])
                        @include('auth.common.controls.select', ['label' => 'Chọn loại cha', 'control_name' => 'parent_id', 'control_id' => 'parent_id'])
