          ...
          <div class="box-body">
            <form id="search_form">
                <div class="form-group">
                    ...
                    <div class="form-group col-md-3 has-feedback">
                      <div class="input-group"><span class="input-group-addon"><i class="fa fa-search"></i></span>
                        <input type="text" class="form-control" name="name" id="name" placeholder="Lọc theo loại sản phẩm" />
                      </div>
                    </div>

                    <div class="form-group col-md-3 has-feedback">
                      <div class="input-group"><span class="input-group-addon"><i class="fa fa-search"></i></span>
                        <input type="text" class="form-control" name="name" id="name" placeholder="Lọc theo nhà cung cấp" />
                      </div>
                    </div>
