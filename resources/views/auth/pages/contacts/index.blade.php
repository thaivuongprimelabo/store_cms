        ...
        <div class="box-body">
          <form id="search_form">
              <div class="form-group">
                  ...
                  <div class="form-group col-md-3 has-feedback">
                    <div class="input-group"><span class="input-group-addon"><i class="fa fa-search"></i></span>
                      <input type="text" class="form-control" name="address" id="address" placeholder="Lọc theo địa chỉ" />
                    </div>
                  </div>

                  <div class="form-group col-md-3 has-feedback">
                    <div class="input-group"><span class="input-group-addon"><i class="fa fa-search"></i></span>
                      <input type="text" class="form-control" name="phone" id="phone" placeholder="Lọc theo số điện thoại" />
                    </div>
                  </div>
